  ...
  return (
    <main className='grid grid-cols-5 bg-background-light h-screen'>
      ...
      >
        ...
        >
          <h1 className='font-sixcaps text-accent-light text-[20vw] tracking-widest leading-none text-center select-none'>
            Velo<br />way
          </h1>
        </div>
      </div>
      ...
      <div
        className={`bg-background-blue col-span-2 shadow-image font-poppins text-white flex flex-col items-center justify-center column form-column ${isLoginPage ? 'order-1 rounded-r-2xl shadow-image-der' : 'order-2 rounded-l-2xl shadow-image-izq'}`}
      >
        {
          isLoginPage
